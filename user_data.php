...
<?php
$sql = "SELECT username, nume, telefon, firstday, lastday FROM rezervari WHERE username='$username'";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    <?php
    echo "Nume: " . $row["nume"] . "<br>" ."Telefon: " . $row["telefon"] . "<br>" . "Data:" . $row["firstday"] . "-" . $row["lastday"] . "<br>" . "<br>";
    ?>
    </div>
    <?php
  }
